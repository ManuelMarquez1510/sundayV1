                        ...
                        props.svg ?
                            ...
                            props.disabled ?
                                props.onClick ?
                                    ...
                                    :
                                    <ButtonReacstrap className={props.disabled ? styles.disabled + ' ' + styles[props.color] + ' ' + styles.button : styles[props.color] + ' ' + styles.button} href={props.href}>
                                        {props.text}
                                    </ButtonReacstrap>
                                :
                                props.onClick ?
                                    <ButtonReacstrap onClick={props.onClick} className={props.disabled ? styles.disabled + ' ' + styles[props.color] + ' ' + styles.button : styles[props.color] + ' ' + styles.button} >
                                        {props.text}
                                    </ButtonReacstrap>
                                    :
                                    <ButtonReacstrap className={props.disabled ? styles.disabled + ' ' + styles[props.color] + ' ' + styles.button : styles[props.color] + ' ' + styles.button} href={props.href}>

            ...
            return (
                <FadeInSection className="h-100 w-100">
                    <div className="position-relative h-100">
                        <img src={props.image} alt={props.title} className="w-100 h-100 img-fluid"/>
                ...
                <FadeInSection className="h-100 w-100">
                    <Row className={styles.card + ' ' + styles.rightCard + ' m-0'}>
                        ...
                        <Col md="6" className="p-0 overflow-hidden">
                            <img src={props.image} alt={props.title} className="w-100 img-fluid" />
                        </Col>
                    </Row>
                </FadeInSection>
            );
            ...
            return (
                <FadeInSection className="h-100 w-100">
                    <Row className={styles.card + ' m-0 left-card'}>
                        <Col md="6" className="p-0 overflow-hidden">
                            <img src={props.image} className="w-100 img-fluid" alt={props.title} />
                        </Col>
                        <Col md="6" className={styles.card + " py-4 d-flex align-items-center"}>
                            <div className="text-center w-100">
                                <div className="text-left">
            ...
            return (
                <FadeInSection>
                    <div className="position-relative">
                        <img src={props.image} alt={props.title} className="img-fluid w-100"/>
